...
public class TaskGenerateDomainEntityService {
    ...
    public void save(TaskGenerateDomainEntityContextDTO taskGenerateDomainEntityContextDTO) {
        taskGenerateDomainEntityContextDTO.getEntity().setType(TypeEntity.DOMAIN);
        taskGenerateDomainEntityContextDTO
            .getEntity()
            .setApplication(taskGenerateDomainEntityContextDTO.getGenerationProcess().getAkipProcess().getApplication());
