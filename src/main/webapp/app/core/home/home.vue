<template>
  <div class="home">
    <div class="card border-primary">
      <div class="card-body">
        <h1 class="display-4" v-text="$t('akipGenerationWebApp.home.title')">Welcome, Java Hipster!</h1>
        <div>
        ...
        <p v-text="$t('akipGenerationWebApp.home.question')">If you have any question on JHipster:</p>
        ...
        <ul>
          <li>
            <a
              ...
              v-text="$t('akipGenerationWebApp.home.link.homepage')"
              >JHipster homepage</a
            >
          </li>
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              v-text="$t('akipGenerationWebApp.home.link.stackoverflow')"
          ...
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              v-text="$t('akipGenerationWebApp.home.link.bugtracker')"
          ...
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              v-text="$t('akipGenerationWebApp.home.link.follow')"
        ...
        <p>
          <span v-text="$t('akipGenerationWebApp.home.like')">If you like AgileKip Generator, don't forget to give us a star on</span>
          <a
            href="https://github.com/agilekip/generator-jhipster-agilekip"
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('akipGenerationWebApp.home.github')"
            >GitHub</a
          >!
        </p>
      </div>
