        ...
        <div class="container">
          ...
          >
            <font-awesome-icon icon="cogs"></font-awesome-icon>&nbsp;<span
              v-text="$t('akipGenerationWebApp.taskConfigureStartFormProcess.configureStartFormProcessAndContinueProcess')"
...
<script lang="ts" src="./task-configure-start-form-process-execute.component.ts"></script>
