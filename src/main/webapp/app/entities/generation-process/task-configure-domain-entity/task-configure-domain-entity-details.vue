      ...
      <div v-if="taskContext.taskInstance">
        ...
        <div class="container">
          ...
          <router-link
            ...
            :to="`/process-definition/GenerationProcess/task/TaskConfigureDomainEntity/${taskContext.taskInstance.id}/execute`"
            tag="button"
...
<script lang="ts" src="./task-configure-domain-entity-details.component.ts"></script>
