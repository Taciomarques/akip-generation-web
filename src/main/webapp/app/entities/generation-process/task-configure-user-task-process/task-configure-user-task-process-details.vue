      ...
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance class="border-primary" :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <show-akip-entity
              ...
              :applicationId="taskContext.akipEntityUserTask.application.id"
            ></show-akip-entity>
          </template>
        ...
        <div class="container">
          ...
          <router-link
            ...
            :to="`/process-definition/GenerationProcess/task/TaskConfigureUserTaskProcess/${taskContext.taskInstance.id}/execute`"
            tag="button"
...
<script lang="ts" src="./task-configure-user-task-process-details.component.ts"></script>
