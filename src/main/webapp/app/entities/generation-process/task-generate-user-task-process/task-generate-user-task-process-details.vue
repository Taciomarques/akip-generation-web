      ...
      <div v-if="taskContext.taskInstance">
        ...
        <div class="container">
          ...
          <router-link
            ...
            :to="`/process-definition/GenerationProcess/task/TaskGenerateUserTaskProcess/${taskContext.taskInstance.id}/execute`"
            tag="button"
...
<script lang="ts" src="./task-generate-user-task-process-details.component.ts"></script>
