...
class AkipAkipProcessResourceIT {
    ...
    private static final StatusProcess DEFAULT_STATUS = StatusProcess.WAITING_CONFIGURE_DOMAIN_ENTITY;
    private static final StatusProcess UPDATED_STATUS = StatusProcess.WAITING_CONFIGURE_PROCESS_BINDING;
