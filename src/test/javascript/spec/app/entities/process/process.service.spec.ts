...
describe('Service Tests', () => {
  describe('Process Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Process', async () => {
      ...
      it('should not update a Process', async () => {
      ...
      it('should partial update a Process', async () => {
      ...
      it('should not partial update a Process', async () => {
      ...
      it('should not return a list of Process', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Process', async () => {
